...
public class PrepareTransfer {
  ...
  public static String testAddressesPath =
      "./src/test/java/test-addresses/TransferTestAddresses.json";
  ...
  /** Prepare addresses for `testAssetInfo0` use testAddress[0] */
  ...
  /** Prepare addresses for `testAssetInfo1` use testAddress[1] */
  ...
  /** Prepare addresses for `testFrom0` use testAddress[2] */
  ...
  /** Prepare addresses for `testFrom1` use testAddress[3] */
  ...
  /** Prepare addresses for `testFrom2` use testAddress[4] */
  ...
  /** Prepare addresses for `testFrom3` use testAddress[5] */
  ...
  /** Prepare addresses for `testFrom4` use testAddress[6] */
  ...
  /** Prepare addresses for `testFrom5` use testAddress[7], testAddress[8] */
  ...
  /** Prepare addresses for `testFrom6` use testAddress[9], testAddress[10] */
  ...
  /** Prepare addresses for `testFrom7` use testAddress[11] */
  ...
  /** Prepare addresses for `testTo0` use testAddress[12] */
  ...
  /** Prepare addresses for `testTo1` use testAddress[13] */
  ...
  /** Prepare addresses for `testTo2` use testAddress[14] */
  ...
  /** Prepare addresses for `testTo3` use testAddress[15] */
  ...
  /** Prepare addresses for `testPayFee0` use testAddress[16], testAddress[17] */
  ...
  /** Prepare addresses for `testPayFee1` use testAddress[18], testAddress[19] */
  ...
  /** Prepare addresses for `testChange0` use testAddress[20] */
  public static void prepareChange0() throws IOException {
    String testAddress = testAddresses.get(20).address;
    BuildUtils.ensureCkbFreeBalance(testAddress, AmountUtils.ckbToShannon(190));
  }

  /** Prepare addresses for `testChange1` use testAddress[21] */
