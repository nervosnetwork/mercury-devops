...
public class TransferTest {
    ...
    void testAssetInfo1() throws IOException {
        ...
        builder.from(From.newFrom(Arrays.asList(ItemFactory.newIdentityItemByAddress(testAddress)), Source.Free));
        builder.to(To.newTo(Arrays.asList(new ToInfo(AddressWithKeyHolder.testAddress0(), BigInteger.valueOf(180))), Mode.HoldByFrom));
        System.out.println(g.toJson(builder.build()));
     ...
     * Params Test
     * - Param: `asset_info`
     * - Value: Arbitary `udt_hash`
     * - Type: Negative Testing
     */
    void testAssetInfo3() throws IOException {
        String request = "{\"asset_info\":{\"asset_type\":\"CKB\",\"udt_hash\":\"dhhf3454554\"},\"from\":{\"items\":[{\"type\":\"Identity\",\"value\":\"0x009b9b8e4d3739f80ea5f209226bf545b5c130438c\"}],\"source\":\"Free\"},\"to\":{\"to_infos\":[{\"address\":\"ckt1qyq28wze3cw48ek9az0g4jmtfs6d8td38u4s6hp2s0\",\"amount\":\"180\"}],\"mode\":\"HoldByTo\"},\"pay_fee\":null,\"change\":null,\"fee_rate\":1000,\"since\":null}";
        rpc.post(
                        RpcMethods.BUILD_TRANSFER_TRANSACTION,
                        g.fromJson(request, JsonObject.class));
    }
    ...
    void testFrom0() throws IOException {
        ...
        builder.assetInfo(AssetInfo.newCkbAsset());
        builder.from(From.newFrom(Arrays.asList(ItemFactory.newIdentityItemByAddress(testAddress)), Source.Free));
        builder.to(To.newTo(Arrays.asList(new ToInfo(AddressWithKeyHolder.testAddress0(), AmountUtils.ckbToShannon(70))), Mode.HoldByFrom));
        System.out.println(g.toJson(builder.build()));
    ...
    void testFrom2() throws IOException {
        ...
        TransferPayloadBuilder builder = new TransferPayloadBuilder();
        builder.assetInfo(AssetInfo.newCkbAsset());
        builder.from(From.newFrom(Arrays.asList(
                ItemFactory.newRecordItemByAddress(new OutPoint("0x52ae55cde686eddd26a62c0316038614adbec88cf0c1929b89b07a0c344c9f95", "0x0"), testAddress),
                ItemFactory.newRecordItemByAddress(new OutPoint("0xd4a2b3ecab39cab5db015144b84a73c93f75db1bdaed4e42d099edd8de46c074", "0x1"), testAddress)
        ), Source.Free));
        builder.to(To.newTo(Arrays.asList(new ToInfo(AddressWithKeyHolder.testAddress0(), AmountUtils.ckbToShannon(70))), Mode.HoldByFrom));
        System.out.println(g.toJson(builder.build()));
     ...
     * Params Test
     * - Param: `from`
     * - Value: identity + claimable（UDT）, testAddress has no acp cell.
     * - Expectation: Udt change will create secp udt cell. Pay attention to the lock_args, it can not be receiver part of cheque args.
     * - Type: Positive Testing
     */
    void testFrom3() throws IOException {
        ...
        TransferPayloadBuilder builder = new TransferPayloadBuilder();
        builder.assetInfo(AssetInfo.newUdtAsset(UdtHolder.UDT_HASH));
        builder.from(From.newFrom(Arrays.asList(ItemFactory.newIdentityItemByAddress(testAddress)), Source.Claimable));
        builder.to(To.newTo(Arrays.asList(new ToInfo(AddressWithKeyHolder.testAddress0(), BigInteger.valueOf(80))), Mode.HoldByFrom));
        System.out.println(g.toJson(builder.build()));
     ...
     * Params Test
     * - Param: `from`
     * - Value: identity + claimable（UDT）, testAddress has an acp cell.
    ...
    void testFrom5() throws IOException {
        ...
        TransferPayloadBuilder builder = new TransferPayloadBuilder();
        builder.assetInfo(AssetInfo.newCkbAsset());
        builder.from(From.newFrom(Arrays.asList(ItemFactory.newIdentityItemByAddress(testAddress1), ItemFactory.newIdentityItemByAddress(testAddress2)), Source.Free));
        builder.to(To.newTo(Arrays.asList(new ToInfo(AddressWithKeyHolder.testAddress0(), AmountUtils.ckbToShannon(200))), Mode.HoldByFrom));
        System.out.println(g.toJson(builder.build()));
    ...
    void testFrom6() throws IOException {
        ...
        TransferPayloadBuilder builder = new TransferPayloadBuilder();
        builder.assetInfo(AssetInfo.newCkbAsset());
        builder.from(From.newFrom(Arrays.asList(ItemFactory.newAddressItem(testAddress1), ItemFactory.newAddressItem(testAddress2)), Source.Free));
        builder.to(To.newTo(Arrays.asList(new ToInfo(AddressWithKeyHolder.testAddress0(), AmountUtils.ckbToShannon(200))), Mode.HoldByFrom));
        System.out.println(g.toJson(builder.build()));
     ...
     * Params Test
     * - Param: `from`
     * - Value: address + free（CKB）, secp address can afford while acp address can not afford, use acp address here
     * - Type: Negative Testing
     */
    void testFrom7() throws IOException {
        ...
        TransferPayloadBuilder builder = new TransferPayloadBuilder();
        builder.assetInfo(AssetInfo.newCkbAsset());
        builder.from(From.newFrom(Arrays.asList(ItemFactory.newAddressItem(testAcpAddress)), Source.Free));
        builder.to(To.newTo(Arrays.asList(new ToInfo(AddressWithKeyHolder.testAddress0(), AmountUtils.ckbToShannon(70))), Mode.HoldByFrom));
        System.out.println(g.toJson(builder.build()));
     ...
     * Params Test
     * - Param: `from`
     * - Value: Arbitary item type
     * - Type: Negative Testing
     */
    void testFrom8() throws IOException {
        String request = "{\"asset_info\":{\"asset_type\":\"CKB\",\"udt_hash\":\"0xf21e7350fa9518ed3cbb008e0e8c941d7e01a12181931d5608aa366ee22228bd\"},\"from\":{\"items\":[{\"type\":\"hhgd\",\"value\":\"0x009b9b8e4d3739f80ea5f209226bf545b5c130438c\"}],\"source\":\"Free\"},\"to\":{\"to_infos\":[{\"address\":\"ckt1qyq28wze3cw48ek9az0g4jmtfs6d8td38u4s6hp2s0\",\"amount\":\"180\"}],\"mode\":\"HoldByTo\"},\"pay_fee\":null,\"change\":null,\"fee_rate\":1000,\"since\":null}";
        rpc.post(
                RpcMethods.BUILD_TRANSFER_TRANSACTION,
                g.fromJson(request, JsonObject.class));
    }
     ...
     * Params Test
     * - Param: `from`
     * - Value: Arbitary item value
     * - Type: Negative Testing
     */
    void testFrom9() throws IOException {
        String request = "{\"asset_info\":{\"asset_type\":\"CKB\",\"udt_hash\":\"0xf21e7350fa9518ed3cbb008e0e8c941d7e01a12181931d5608aa366ee22228bd\"},\"from\":{\"items\":[{\"type\":\"Identity\",\"value\":\"fererggtr\"}],\"source\":\"Free\"},\"to\":{\"to_infos\":[{\"address\":\"ckt1qyq28wze3cw48ek9az0g4jmtfs6d8td38u4s6hp2s0\",\"amount\":\"180\"}],\"mode\":\"HoldByTo\"},\"pay_fee\":null,\"change\":null,\"fee_rate\":1000,\"since\":null}";
        rpc.post(
                RpcMethods.BUILD_TRANSFER_TRANSACTION,
                g.fromJson(request, JsonObject.class));
    }
    ...
    void testFrom11() throws IOException {
        ...
        TransferPayloadBuilder builder = new TransferPayloadBuilder();
        builder.assetInfo(AssetInfo.newCkbAsset());
        builder.from(From.newFrom(Arrays.asList(ItemFactory.newIdentityItemByAddress(testAddress1), ItemFactory.newAddressItem(testAddress2)), Source.Free));
        builder.to(To.newTo(Arrays.asList(new ToInfo(AddressWithKeyHolder.testAddress0(), AmountUtils.ckbToShannon(200))), Mode.HoldByFrom));
        System.out.println(g.toJson(builder.build()));
     ...
     * Params Test
     * - Param: `to`
     * - Value: secp address + HoldByFrom（CKB）
     * - Type: Positive Testing
     */
    void testTo0() throws IOException {
        ...
        builder.assetInfo(AssetInfo.newCkbAsset());
        builder.from(From.newFrom(Arrays.asList(ItemFactory.newIdentityItemByAddress(testAddress)), Source.Free));
        builder.to(To.newTo(Arrays.asList(new ToInfo(AddressWithKeyHolder.testAddress0(), AmountUtils.ckbToShannon(100))), Mode.HoldByFrom));
        System.out.println(g.toJson(builder.build()));
     ...
     * Params Test
     * - Param: `to`
     * - Value: secp address + HoldByFrom（UDT）
     * - Type: Positive Testing
     */
    void testTo1() throws IOException {
        ...
        builder.assetInfo(AssetInfo.newUdtAsset(UdtHolder.UDT_HASH));
        builder.from(From.newFrom(Arrays.asList(ItemFactory.newIdentityItemByAddress(testAddress)), Source.Free));
        builder.to(To.newTo(Arrays.asList(new ToInfo(AddressWithKeyHolder.testAddress0(), BigInteger.valueOf(100))), Mode.HoldByFrom));
        System.out.println(g.toJson(builder.build()));
     ...
     * Params Test
     * - Param: `to`
     * - Value: secp address + HoldByTo（UDT）
     * - Expectation: Acp cell should be enough to afford fee
     * - Type: Positive Testing
     */
    void testTo2() throws IOException {
        ...
        builder.assetInfo(AssetInfo.newUdtAsset(UdtHolder.UDT_HASH));
        builder.from(From.newFrom(Arrays.asList(ItemFactory.newIdentityItemByAddress(testAddress)), Source.Free));
        builder.to(To.newTo(Arrays.asList(new ToInfo(AddressWithKeyHolder.testAddress0(), BigInteger.valueOf(100))), Mode.HoldByTo));
        System.out.println(g.toJson(builder.build()));
     ...
     * Params Test
     * - Param: `to`
     * - Value: acp address + HoldByTo（UDT）
     * - Type: Positive Testing
     */
    /**
     * Case Test
     * - One address send all its CKB to another address, by using a third address to pay fee.
     */
    void testTo3() throws IOException {
        ...
        TransferPayloadBuilder builder = new TransferPayloadBuilder();
        builder.assetInfo(AssetInfo.newUdtAsset(UdtHolder.UDT_HASH));
        builder.from(From.newFrom(Arrays.asList(ItemFactory.newIdentityItemByAddress(testAcpAddress)), Source.Free));
        builder.to(To.newTo(Arrays.asList(new ToInfo(AddressWithKeyHolder.testAddress0(), BigInteger.valueOf(100))), Mode.HoldByTo));
        System.out.println(g.toJson(builder.build()));
     ...
     * Params Test
     * - Param: `to`
     * - Value: negative transfer amount
     * - Type: Negative Testing
     */
     ...
     * Params Test
     * - Param: `to`
     * - Value: transfer amount larger than free balance
     * - Type: Negative Testing
     */
    void testTo6() throws IOException {
        ...
        builder.assetInfo(AssetInfo.newUdtAsset(UdtHolder.UDT_HASH));
        builder.from(From.newFrom(Arrays.asList(ItemFactory.newIdentityItemByAddress(testAddress)), Source.Free));
        builder.to(To.newTo(Arrays.asList(new ToInfo(AddressWithKeyHolder.testAddress0(), BigInteger.valueOf(100000))), Mode.HoldByTo));
        System.out.println(g.toJson(builder.build()));
     ...
     * Params Test
     * - Param: `to`
     * - Value: cheque address + HoldByFrom（CKB）
     * - Type: Negative Testing
     */
    void testTo7() throws IOException {
        // cheque address
        String testAddress = "ckt1qpsdtuu7lnjqn3v8ew02xkwwlh4dv5x2z28shkwt8p2nfruccux4kqftchvd55ayfedxykhh4z0rlkrmhqlpu378wt6d3pw2v2zaslvzhrkuzepal8euucck2akla";
        TransferPayloadBuilder builder = new TransferPayloadBuilder();
        builder.assetInfo(AssetInfo.newUdtAsset(UdtHolder.UDT_HASH));
        builder.from(From.newFrom(Arrays.asList(ItemFactory.newIdentityItemByAddress(testAddress)), Source.Free));
        builder.to(To.newTo(Arrays.asList(new ToInfo(AddressWithKeyHolder.testAddress0(), BigInteger.valueOf(100))), Mode.HoldByTo));
    ...
    /**
     * Case Test
     * - One address only have one acp cell, and extra 1 free CKB on it. It can pay fee to support UDT transfer.
     */
    void testCase1() throws IOException {
        ...
        builder.assetInfo(AssetInfo.newCkbAsset());
        builder.from(From.newFrom(Arrays.asList(ItemFactory.newIdentityItemByAddress(testAddress)), Source.Free));
        builder.to(To.newTo(Arrays.asList(new ToInfo(AddressWithKeyHolder.testAddress0(), AmountUtils.ckbToShannon(199))), Mode.HoldByFrom));
        builder.change(AddressWithKeyHolder.testAddress0());
        System.out.println(g.toJson(builder.build()));
