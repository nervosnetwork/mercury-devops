...
public class DaoTests {
     ...
     */
    void testDepositFromAddress0() throws IOException {
        PrepareDao.prepareDepositFromAddress0();
     ...
     * - Type: Positive Testing
     */
    void testDepositFromAddress1() throws IOException {
        PrepareDao.prepareDepositFromAddress1();
        String testAddress = PrepareDao.testAddresses.get(1).address;
        DaoDepositPayloadBuilder builder = new DaoDepositPayloadBuilder();
        builder.from(
                From.newFrom(
                        Arrays.asList(ItemFactory.newAddressItem(testAddress)),
        ...
        cw1.write("testDepositFromAddress1", builder.build(), response, null);
     ...
     * - Type: Positive Testing
     */
    void testWithdrawFromAddress1() throws IOException {
        String testAddress = PrepareDao.testAddresses.get(1).address;
        DaoWithdrawPayloadBuilder builder = new DaoWithdrawPayloadBuilder();
        builder.from(ItemFactory.newAddressItem(testAddress));
