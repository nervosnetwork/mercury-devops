...
public class MercuryCell {
    ...
    private Integer consumedTxIndex;
    ...
    private HexBytes consumedBlockHash;

    private HexBytes consumedTxHash;

    private HexBytes since;
    ...
    public Long getConsumedBlockNumber() {
        return consumedBlockNumber;
    }

    public void setConsumedBlockNumber(Long consumedBlockNumber) {
        this.consumedBlockNumber = consumedBlockNumber;
    }

    public Integer getConsumedTxIndex() {
        return consumedTxIndex;
    }

    public void setConsumedTxIndex(Integer consumedTxIndex) {
        this.consumedTxIndex = consumedTxIndex;
    }
    ...
    public HexBytes getConsumedBlockHash() {
        return consumedBlockHash;
    }

    public void setConsumedBlockHash(HexBytes consumedBlockHash) {
        this.consumedBlockHash = consumedBlockHash;
    }

    public HexBytes getConsumedTxHash() {
        return consumedTxHash;
    }

    public void setConsumedTxHash(HexBytes consumedTxHash) {
        this.consumedTxHash = consumedTxHash;
    }

    public HexBytes getSince() {
        return since;
    }

    public void setSince(HexBytes since) {
        this.since = since;
    }
}